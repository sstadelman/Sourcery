...
public enum TemplateAnnotationsParser {
    ...
    static public func parseAnnotations(_ annotation: String, contents: String, aggregate: Bool = false) -> (contents: String, annotatedRanges: [String: [NSRange]]) {
    ...
    static public func annotationRanges(_ annotation: String, contents: String, aggregate: Bool = false) -> (annotatedRanges: [String: [NSRange]], rangesToReplace: Set<NSRange>) {
    ...
    static public func removingEmptyAnnotations(from content: String) -> String {
