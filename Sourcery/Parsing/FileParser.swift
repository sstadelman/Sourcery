...
private var inUnitTests2 = NSClassFromString("XCTest") != nil
final public class FileParser {

    private static let version: String = inUnitTests2 ? "Major.Minor.Patch" : Version.current.value
    ...
    public func parse() throws -> FileParserResult {
        ...
        return FileParserResult(path: path, module: module, types: types, typealiases: typealiases, inlineRanges: inlineRanges, contentSha: initialContents.sha256() ?? "", sourceryVersion: FileParser.version)
    }
...
extension FileParser {
    ...
    public func extractInheritedTypes(source: [String: SourceKitRepresentable]) -> [String] {
