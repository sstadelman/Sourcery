...
class CodeSign:
    def __init__(self):
        ...
        if not self.sdk.startswith('macosx'):
            return
    ...
    def codeSignFrameworks(self, frameworkPath):
        ...
        frameworks = [dir for dir in os.listdir(frameworkPath) if dir.endswith('.framework')]

        for framework in frameworks:
            binaryPath = frameworkPath + "/" + framework + "/Versions/A"
